...
<Tabs>
  ...
  <Tab title="Quick Actions">
    ...
    - **Add ASINs**: Upload new products for monitoring
    - **Configure Alerts**: Adjust your alert preferences
    - **View Reports**: Access detailed analytics and reports
    - **Account Settings**: Manage your account configuration
  </Tab>
...
- **Preferences**: Configure alert settings
- **Account**: Access account management options
